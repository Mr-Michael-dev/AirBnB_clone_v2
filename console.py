...
class HBNBCommand(cmd.Cmd):
    ...
    def do_create(self, args):
        ...
        c_name, *kwargs_string = args.split(" ", 1)
        if not c_name:
        ...
        if not kwargs_string:
            ...
            kwargs = {}
            for kv_pair in kwargs_string[0].split(','):
                key, value_str = kv_pair.strip().split('=', 1)
                try:
    ...
    def do_show(self, args):
        ...
        storage_obj = HBNBCommand.storage
        try:
            print(storage_obj.all()[key])
        except KeyError:
    ...
    def do_count(self, args):
        ...
        count = 0
        if args:
            count = len(storage.all(cls=args))
        print(count)
